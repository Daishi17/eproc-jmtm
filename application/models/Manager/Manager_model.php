...
class Manager_model extends CI_Model
{
   ...
   var $order = array('id_pegawai', 'nama_pegawai', 'nip', 'nama_unit_kerja', 'alamat', 'tanggal_pendaftaran', 'telepon', 'no_sk', 'id_pegawai');
   var $column_search = array('id_pegawai', 'nama_pegawai', 'nip', 'nama_unit_kerja', 'alamat', 'tanggal_pendaftaran', 'telepon', 'no_sk');
   ...
   private function _get_data_query()
   {
      ...
      $this->db->where('tbl_role.id_role', 6);
      // $this->db->order_by('tbl_pegawai', 'id_pegawai');
