...
{
	var $table = 'tbl_sbu';
	var $order = array('id_sbu', 'kode_sbu', 'nama_sbu', 'id_sbu');
	...
	public function getByid($id_sbu)
	{
		return $this->db->get_where($this->table, ['id_sbu' => $id_sbu])->row();
	}
	...
	{
		$this->db->delete($this->table, ['id_sbu' => $id_sbu]);
		return $this->db->affected_rows();
	}
}
