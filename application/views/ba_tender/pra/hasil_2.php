                        ...
                        foreach ($vendor_mengikuti as $key => $value) { ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <?php if (!$value['ev_admin_pra2']) { ?>
                                        Lulus / Gugur
                                    <?php } else if ($value['ev_admin_pra2'] == 1) {  ?>
                                        Lulus
                                    <?php } else if ($value['ev_admin_pra2'] == 2) {  ?>
                                        Gugur
                                    <?php } else {  ?>
                                ...
                                <td style="text-align: center;">
                                    <?php if (!$value['ev_keuangan_pra2']) { ?>
                                        Lulus / Gugur
                                    <?php } else if ($value['ev_keuangan_pra2'] == 1) {  ?>
                                        Lulus
                                    <?php } else if ($value['ev_keuangan_pra2'] == 2) {  ?>
                                        Gugur
                                    <?php } else {  ?>
                                ...
                                <td style="text-align: center;">
                                    <?php if (!$value['ev_teknis_pra1']) { ?>
                                        Lulus / Gugur
                                    <?php } else if ($value['ev_teknis_pra2'] == 1) {  ?>
                                        Lulus
                                    <?php } else if ($value['ev_teknis_pra2'] == 2) {  ?>
                                        Gugur
                                    <?php } else {  ?>
                                ...
                                <td style="text-align: center;">
                                    <?php if (!$value['ket_pra2']) { ?>
                                        Lulus / Gugur
                                    <?php } else if ($value['ket_pra2'] == 1) {  ?>
                                        Lulus
                                    <?php } else if ($value['ket_pra2'] == 2) {  ?>
                                        Gugur
                                    <?php } else {  ?>
