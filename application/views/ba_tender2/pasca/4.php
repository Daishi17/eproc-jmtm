<div class="container">
    <form action="javascript:;" method="POST" id="form_ba_pasca4">
        <?php $id_paket = $paket['id_paket'] ?>
        <button type="submit" onclick="simpan_ba_pasca4('<?= $id_paket ?>')" class="btn btn-success">Simpan</button>

        <a target="_blank" href="<?= base_url('panitiajmtm/beranda/hasil_ba_pasca_4/' . $paket['id_paket']) ?>" class="btn btn-primary">Lihat Hasil</a>
        ...
        <div class="container">
                ...
                <tbody>
                    ...
                    foreach ($vendor_mengikuti as $key => $value) { ?>
                        <tr>
                            ...
                            <td style="text-align: center;">Rp. <?= number_format($value['nilai_penawaran'], 2, ',', '.') ?></td>
                            <td style="text-align: center;">Rp. <?= number_format($value['nilai_terkoreksi'], 2, ',', '.')  ?></td>
                            <td style="text-align: center;">...</td>
                            <td style="text-align: center;">...</td>
                            <td style="text-align: center;">Rp. <?= number_format($value['negosiasi'], 2, ',', '.') ?></td>
                        </tr>
                    <?php   } ?>
            ...
            <p style="text-align:justify; font-size:15px">Dalam kegiatan Penilaian Kewajaran Harga terhadap semua Harga Satuan Penawaran dari Peserta Penawaran. Selanjutnya Panitia Pengadaan melakukan klarifikasi terhadap Harga Satuan Penawaran yang lebih dari 110% terhadap Harga Satuan dalam Harga Perkiraan Sendiri (HPS) yang dinyatakan sebagai Harga Satuan Timpang (Terlampir).</p>

            <p style="text-align:justify; font-size:15px">Dari hasil klarifikasi yang telah dilakukan, maka :</p>

            <ol type="a" style="text-align:justify; font-size:15px">
                <li>
                    Harga Satuan Penawaran yang dinyatakan sebagai Harga Satuan Timpang lebih dari 110% terhadap Harga Satuan dalam HPS
                </li>
            </ol>


            <p style="text-align:justify; font-size:15px">Harga Satuan Timpang dimaksud hanya berlaku untuk Kuantitas Awal sebagaimana dimaksud dalam Daftar Kuantitas dan Harga. Selanjutnya jika dalam pelaksanaan Kontrak terjadi pertambahan Kuantitas terhadap Kuantitas Awal dimaksud, maka akan diberlakukan Harga </p>

            <p style="text-align:justify; font-size:15px">Satuan yang baru untuk pertambahan Kuantitas tersebut sesuai kesepakatan antara Para Pihak sebagaimana dimaksud dalam Kontrak.

                Selanjutnya dari hasil penilaian kewajaran harga yang telah dilakukan terhadap Harga Satuan Penawaran (<select name="sts_perlu" id="">
                    <?php if ($data_ba_pasca4['sts_perlu'] == 1) { ?>
                ...
                </select> (coret yang tidak perlu)) harga yang lebih 110% terhadap Harga Satuan dalam Harga Perkiraan Sendiri
            </p>
            ...
            <p style="text-align:justify; font-size:15px">Satuan yang baru untuk pertambahan Kuantitas tersebut sesuai kesepakatan antara Para Pihak sebagaimana dimaksud dalam Kontrak.
                ...
                Dari hasil Koreksi Aritmatik yang telah dilakukan, didapatkan Daftar Peringkat sebagai berikut:
            </p>
...
<div class="modal fade" id="edit_nilai_pasca4" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Data Evaluasi <label id="nm_vendor4_pasca"></label></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="javascript:;" id="save_ba4_vendor_form_pasca">
                <input type="hidden" name="id_mengikuti_paket4" id="id_mengikuti_paket4_pasca">
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="id_mengikuti_paket" id="id_mengikuti_paket4">
                        <div class="col-md-12">
                            <label for="">HPS</label>
                            <input type="text" name="hps_pasca4" class="form-control form-control-sm">

                            <label for="">Nilai harga Penawaran (NHP)</label>
                            <input type="text" name="nhp_pasca4" class="form-control form-control-sm">

                            <label for="">Peringkat Sementara</label>
                            <input type="text" name="peringkat_pasca4" class="form-control form-control-sm">


                            <label for="">Keterangan</label>
                            <select name="ket_pasca4" id="" class="form-control form-control-sm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="save_ba4_vendor_pasca()" class="btn btn-success">Simpan</button>
                </div>
            </form>
        </div>
    </div>
