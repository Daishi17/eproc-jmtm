...
<head>
    <title>Ba-04-KOREKSI ARITMATIK HARGA TIMPANG DAN NEGOSIASI</title>
    <meta charset="utf-8">
        ...
        <form action="javascript:;" method="POST" id="form_ba_pasca4">
            ...
            <div class="container">
                ...
                <p style="text-align:justify; font-size:15px">Satuan yang baru untuk pertambahan Kuantitas tersebut sesuai kesepakatan antara Para Pihak sebagaimana dimaksud dalam Kontrak.
                    ...
                    Selanjutnya dari hasil penilaian kewajaran harga yang telah dilakukan terhadap Harga Satuan Penawaran (
                    <?php if ($data_ba_pasca4['sts_perlu'] == 1) { ?>
                        ada / <del>tidak ada</del>
                    <?php  } else { ?>
                        <del>ada</del> / tidak Ada
                        <?php   }  ?>(coret yang tidak perlu)) harga yang lebih 110% terhadap Harga Satuan dalam Harga Perkiraan Sendiri
                </p>
                    ...
                    <tbody>
                        ...
                        foreach ($vendor_mengikuti as $key => $value) { ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <?php if (!$value['peringkat_pasca4']) { ?>
                                        0
                                    <?php } else {  ?>
                                        <?= $value['peringkat_pasca4'] ?>
                                    <?php }  ?>
                                </td>
                                <td style="text-align: center;">
