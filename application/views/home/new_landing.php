            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 d-flex justify-content-center justify-content-lg-start">
                        <a style="text-decoration: none;font-weight:bold;color:#FFD700" href="#"> <i class="text-warning fas fa fa-laptop"></i> Aplikasi E-Procurement JMTM</a>
                    </div>
                    <div class="col-lg-8 d-sm-flex justify-content-center justify-content-lg-end">
                        <ul class="list-unstyled d-flex justify-content-center mb-0 mr-sm-5">
                            <li class="mr-2"><a target="_blank" style="text-decoration: none;font-weight:bold;color:white" href="https://www.youtube.com/watch?v=2Dvpy_mZ4SE"><i class="fab fa-youtube mr-2"></i>OFFICIAL YOUTUBE</a></li>
                            <li class="mr-2"><a style="text-decoration: none;font-weight:bold;color:white" href="javascript:;" data-toggle="modal" data-target="#tentangkami"><i class="fa fa-building mr-2"></i>TENTANG KAMI</a></li>
                            <li class="mr-2"><a style="text-decoration: none;font-weight:bold;color:white" target="_blank" href="https://api.whatsapp.com/send?phone=+6281526804622&text=HALLO JASAMARGA TOLLROAD MAINTENANCE" style="color: white;"><i class="fa fa-phone mr-2"></i>KONTAK KAMI</a></li>
                            <li class="mr-2"><a style="text-decoration: none;font-weight:bold;color:white" href="javascript:;" data-toggle="modal" data-target="#ketentuan"><i class="fas fa fa-book"></i> PERSYARATAN DAN KETENTUAN</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-9 col-xl-7">
                        <div class="navbar-expand-lg text-right text-lg-left p-0">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="main-contact text-white">
                                            ...
                                            <div class="main-contact-info">
                                                <h6 class="text-white">Kantor Pusat Jasamarga
                                                </h6>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="main-contact text-white">
                                            ...
                                            <div class="main-contact-info">
                                                ...
                                                <small>procurement@jmtm.co.id</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container-fluid position-relative">
                                <div class="navbar-collapse collapse" style="width: 100%;">
                                    <ul class="nav navbar-nav">
                                        <li class="mr-1"><a class="nav-link" href="<?= base_url('') ?>">BERANDA</a></li>
                                        <li class="mr-1"><a class="nav-link" href="<?= base_url('home/cari_paket') ?>">CARI PAKET</a></li>
                                        <li class="mr-1"><a class="nav-link" href="#" data-toggle="modal" data-target="#regulasi">REGULASI</a></li>
                                        <li class=""><a class="nav-link" href="https://www.instagram.com/jmtm.official/">KONTENT KHUSUS</a></li>
                                    </ul>
                                </div>
                                <div class="d-none d-lg-block text-right">
                                    <a style="width: 200px;" class="btn btn-sm btn-primary" target="_blank" href="https://vms.jmtm.co.id/home/daftarvendor">DAFTAR PENYEDIA</a>
                                </div>
                                <div class="d-none d-lg-block text-right">
                                    <a class="btn btn-sm btn-primary" href="javascript:;" onclick="modal_login()">LOGIN</a>
                                </div>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 mb-4 mb-lg-0">
                        <div class="banner-inner-title">
                            ...
                            <img src="<?= base_url('assets/img/jmtm2.png') ?>" width="50%" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 offset-xl-1 col-xl-5">
                        <div class="float-right">
                            <a style="font-size: 50px;" href="javascript:;" onclick="hidupkan()"><i class="fa fa-volume-up"></i></a>
                        </div>
                    </div>
                </div>
            </div>
