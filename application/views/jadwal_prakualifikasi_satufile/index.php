			...
			<div class="modal-body">
				<form action="#" id="formData">
					...
					<div class="form-group">
						<label for="nama_jadwal_tender">Nama Jadwal</label>
						<input type="text" class="form-control" name="nama_jadwal_tender" id="nama_jadwal_tender" placeholder="Nama Jadwal">
