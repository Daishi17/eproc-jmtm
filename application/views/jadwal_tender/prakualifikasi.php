	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalTitle">Add Jadwal Prakualifikasi</h5>
			...
			<div class="modal-body">
				<form action="#" id="formData">
					...
					<div class="form-group">
						<label for="nama_jadwal_tender">Nama Jadwal Prakualifikasi</label>
						<input type="text" class="form-control" name="nama_jadwal_tender" id="nama_jadwal_tender" placeholder="Nama Jadwal Prakualifikasi">
