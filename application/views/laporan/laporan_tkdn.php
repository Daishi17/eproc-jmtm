...
<div id="main" class="container-fluid">
    ...
    <ol class="breadcrumb btn-grad">
        <li><a style="text-decoration: none; color:white;" href="#">Laporan TKDN/PDN</a></li>
    </ol>
    <div class="content" style="box-shadow: 2px 2px 10px 2px black;">
				...
				<div class="col-md-4">
					<div class="formline">
						<select name="id_unit_kerja" id="id_unit_kerja" class="form-control select2">
							...
							<?php foreach ($gethivisi as $key => $value) { ?>
        ...
        <div style="overflow-x: auto;">
            <table class="table table-bordered" id="table_tkdn" style="text-align: center; font-size:10px">
                <thead>
                    <tr>
                        <th rowspan="3">No</th>
                        <th rowspan="3">Nama Pekerjaan</th>
                        <th colspan="3">Komitmen Tahun 2023</th>
                        <th colspan="12">Realisasi Tahun 2023</th>
                    </tr>
                    <tr>
                        <th rowspan="2">Jenis Pekerjaan</th>
                        <th rowspan="2">Jenis Anggaran</th>
                        <th rowspan="2">Komitmen Anggaran 2023</th>
                        <th rowspan="2">Nilai Kontrak Keseluruhan</th>
                        <th rowspan="2">Nilai Kontrak Tahun 2023</th>
                        <th rowspan="2">Nama Penyedia Barang dan Jasa</th>
                        <th rowspan="2">Kualifikasi Penyedia (UMKK/Menengah/Besar)</th>
                        <th rowspan="2">Status Pencatatan (PDN/TKDN/IMPOR)</th>
                        <th colspan="4">Rincian HPS</th>
                        <th rowspan="2">Realisasi Waktu Mulai Kontrak</th>
                        <th rowspan="2">Realisasi Waktu Berakhir Kontrak</th>
                    ...
                    <tr>
                        <th>Panduan</th>
                        <th>Diisi dengan nama Pekerjaan yang Pengadaan Barang dan Jasanya serta Kontraknya dilaksanakan pada Tahun 2023</th>
                        <th>Diisi dengan Jenis Pekerjaan sesuai dengan Pilihan yang tersedia</th>
                        <th>Diisi dengan Jenis Anggaran Sesuai dengan Pilihan Yang tersedia</th>
                        <th>Diisi dengan Komitmen Anggaran sesuai RKAP Tahun 2023</th>
                        <th>Diisi dengan Total Nilai Kontrak secara keseluruhan (termasuk jika <i>Multi Years</i>)</th>
                        <th>Diisi dengan Nilai Kontrak sesuai RKAP Tahun 2023</th>
                        <th>Diisi dengan Nama Penyedia Barang dan Jasa</th>
                        <th>Diisi dengan Kualifikasi Penyedia Barang dan Jasa</th>
                        <th>Diisi dengan Status Pencatatan Pekerjaan sesuai Panduan Kemenkomarves</th>
                        <th>Diisi dengan capaian persentase PDN sesuai HPS Pengadaan Barang dan Jasa</th>
                        <th>Diisi dengan capaian persentase TKDN sesuai HPS Pengadan Barang dan Jasa</th>
                        <th>Diisi dengan capaian persentase Impor sesuai HPS Pengadaan Barang dan Jasa</th>
                        <th>Diisi dengan total Bobot TKDN + PDN + Impor pada HPS</th>
                        <th>Diisi dengan realisasi waktu Mulai Kontrak Tahun 2023</th>
                        <th>Diisi dengan realisasi waktu berakhir Kontrak</th>
                        <th>Diisi dengan keterangan lainnya (jika diperlukan)</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
