...
<div class="container">
	...
	<ol class="breadcrumb" style=" background-image: linear-gradient(to top,rgb(35, 32, 223),rgba(11, 76, 255, 0.63)) !important;">
		<li><a style="text-decoration: none; color:white;" href="#">Edit Manager</a></li>
			...
			<form action="#" id="formData">
				...
				<table class="table">
					...
					<tr>
						...
						<td colspan="3"> <input type="text" name="telepon" value="<?= $agency['telepon'] ?>" class="form-control form-control-sm col-md-3">
					...
					<tr>
						...
						<td colspan="4"> <input type="email" name="email" value="<?= $agency['email'] ?>" class="form-control form-control-sm col-md-6">
