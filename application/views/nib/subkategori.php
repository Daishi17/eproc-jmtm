<div class="container">
	...
	<ol class="breadcrumb" style=" background-image: linear-gradient(to top,rgb(35, 32, 223),rgba(11, 76, 255, 0.63)) !important;">
		<li><a style="text-decoration: none; color:white;" href="#"><?= $jenis_kategori['nib'] ?></a></li>
	...
	<div class="content">
		...
		<input type="hidden" value="<?= $id_nib ?>" name="id_nib" id="id_nib">
			...
			<div class="modal-body">
				<form action="#" id="formData">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="sub_kategori_nib" id="sub_kategori_nib" placeholder="Kategori Nomor Induk Berusaha">
