<div class="container">
	...
	<ol class="breadcrumb" style=" background-image: linear-gradient(to top,rgb(35, 32, 223),rgba(11, 76, 255, 0.63)) !important;">
		<li><a style="text-decoration: none; color:white;" href="#"><?= $jenis_kategori['sub_kategori_nib2'] ?></a></li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" id="formData">
					<input type="hidden" value="<?= $id_sub_kategori ?>" name="id_sub_kategori2" id="id_sub_kategori2">
					<input type="hidden" name="id_sub_kategori3" id="id_sub_kategori3">
					<div class="form-group">
						<label for="nib"> Kategori Nomor Induk Berusaha</label>
						<input type="text" class="form-control" name="sub_kategori_nib3" id="sub_kategori_nib3" placeholder="Kategori Nomor Induk Berusaha">
