		...
		if ($('.file_surat_penetapan_pemenang').val() == '') {
			...
			$.ajax({
				...
				success: function(response) {
					window.open('https://api.whatsapp.com/send?phone=+62' + response['telpon'] + '&text=Anda Telah Di Tetapkan Sebagai Pemenang Lihat Surat Penetapan Pemenangnya http://jmtm-eproc.kintekindo.net/dokumen_file_surat_penetapan_pemenang/' + response['filenya']);
					var percentage = 0;
