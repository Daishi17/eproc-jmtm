...
<?php if ($ambil_paket['id_kualifikasi'] == 11 || $ambil_paket['id_kualifikasi'] == 7 || $ambil_paket['id_kualifikasi'] == 17) { ?>
	<div id="main" class="container">
		...
		<ul class="nav nav-tabs">
			...
			<?php if ($ambil_paket['id_kualifikasi'] == 16  || $ambil_paket['id_kualifikasi'] == 14 || $ambil_paket['id_kualifikasi'] == 12) { ?>
		...
		<div class="col-md-12 col-xl-12 chat">
			<div class="card">
				...
				<?php if (date('Y-m-d H:i', strtotime($get_tahap_penetapan_pemenang['tanggal_selesai_jadwal'])) >= date('Y-m-d H:i') || date('Y-m-d H:i', strtotime($get_tahap_penetapan_pemenang['tanggal_mulai_jadwal'])) == date('Y-m-d H:i')) { ?>
					<div class="card-footer btn-grad5">
						<form id="form_add_negosiasi_tender" enctype="multipart/form-data">
							<div class="input-group">
								...
								<?php
								if (date('Y-m-d H:i', strtotime($get_tahap_penetapan_pemenang['tanggal_mulai_jadwal'])) >= date('Y-m-d H:i')) { ?>
					...
					<div class="card-footer btn-grad5">
						<form id="form_add_negosiasi_tender" enctype="multipart/form-data">
							<div class="input-group">
								...
								<?php
								if (date('Y-m-d H:i', strtotime($get_tahap_negosiasi_seleksi['tanggal_mulai_jadwal'])) >= date('Y-m-d H:i')) { ?>
									<textarea name="isi" class="form-control type_msg" placeholder="Type your message..."></textarea>
									<div class="input-group-append">
										<button type="submit" id="upload" name="upload" class="input-group-text send_btn"><i class="fas fa-location-arrow"></i></button>
									</div>

								<?php	} else if (date('Y-m-d H:i', strtotime($get_tahap_negosiasi_seleksi['tanggal_selesai_jadwal'])) >= date('Y-m-d H:i') || date('Y-m-d H:i', strtotime($get_tahap_negosiasi_seleksi['tanggal_mulai_jadwal'])) == date('Y-m-d H:i')) { ?>
									<textarea name="isi" class="form-control type_msg" placeholder="Type your message..."></textarea>
									<div class="input-group-append">
										<button type="submit" id="upload" name="upload" class="input-group-text send_btn"><i class="fas fa-location-arrow"></i></button>
									</div>
				...
				<div class="card-footer btn-grad5">
					<form id="form_add_negosiasi_tender" enctype="multipart/form-data">
						<div class="input-group">
							...
							<div class="input-group-append">
								<div class="input-group-text attach_btn">
									<button title="Lampiran (PDF,Excel,Word)" class="btn btn-danger  btn-md btn-block" type="button" id="loadFileXml" value="loadXml" onclick="document.getElementById('file').click();"><i class="fas fa-paperclip"></i></button>
									<br>
									<button title="Foto" class="btn btn-primary btn-md btn-block" type="button" id="loadFileXml" value="loadXml" onclick="document.getElementById('file_img').click();"><i class="fas fa-camera-retro"></i></button>
								</div>
								<input type="file" style="display:none;" id="file" name="dokumen_chat" />
								<input type="file" style="display:none;" id="file_img" name="img_chat" />
							</div>
