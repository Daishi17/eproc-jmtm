...
<head>
    <title>Pakta Integritas - Panitia</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="container">
                ...
                <br>
                <div class="container">
                    <label for="">Dengan ini menyatakan dengan sebenarnya bahwa :</label>
                    <ol>
                    ...
                    <label for="" class="float-right">Jakarta, <?= date('d F Y', strtotime($tgl_pakta['created_at'])) ?></label>
                </div>
            </div>
        </div>
    </div>
                ...
                <?php foreach ($ambil_panitia as $key => $value) { ?>
                    <div class="col-md-4 mb-5">
                        <center>
                            ...
                            <br>
                            <br>
                            <?= $value['nama_pegawai'] ?><br>
                            <?= $value['nama_role_panitia'] ?>
                        </center>
                    </div>
                <?php  } ?>
            </div>
