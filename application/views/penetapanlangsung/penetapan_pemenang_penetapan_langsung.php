...
<div class="container">
	...
	<?php if ($this->session->userdata('id_role') == 3) { ?>
		<ol class="breadcrumb btn-grad100" href="#">Penetapan Pemenang</a></li>
		</ol>
	<?php  } else { ?>
		<ol class="breadcrumb btn-grad100" href="#">Penetapan Pemenang</a></li>
		</ol>
	...
	<div class="content">
		...
		<div class="card">
			<div class="card-header btn-grad6">Kirim File Surat Penetapan Pemenang</div>
			<div class="card-body">
				<center>
		...
		<center>
			<?php if ($this->session->userdata('id_role') == 3) { ?>
				...
				<a style="width: 200px;" class="btn btn-grad201" href="<?= base_url('penetapanlangsung/informasipaket/' . $paket['id_paket']) ?>">Kembali</a>
			<?php } else { ?>
				...
				<?php   } else if ($paket['id_metode_pemilihan'] == 9) { ?>
					<a href="<?= base_url('penetapanlangsung/informasipaket/' . $paket['id_paket']) ?>" style="width: 200px;" class="btn btn-grad201">Kembali</a>
				<?php   } else { ?>
