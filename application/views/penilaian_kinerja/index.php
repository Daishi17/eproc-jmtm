    ...
    <div class="content">
        <div class="card" style="box-shadow: 2px 2px 10px 2px black;">
            <div class="card-header btn-grad">
                <i class="fas fa-chart-line"></i> Penilaian Kinerja Vendor
            </div>
            <div class="card-body">
                ...
                <div class="card" style="box-shadow: 2px 2px 10px 2px black;">
                    <div class="card-header btn-grad">
                        <i class="fas fa-chalkboard-teacher"></i> Data Vendor Pemenang
                    </div>
                    <div class="card-body">
                            ...
                            <table id="tbl_vendor_pemenang" class="table table-hover table-bordered">
                                <thead class="btn-grad">
                                    <tr style="font-size: 11px;">
                                        ...
                                        <th>Performance Kinerja</th>
                                        <th>Performance Peringatan</th>
                                        <th>Nilai Akhir Kinerja</th>
                                    </tr>
                                </thead>
