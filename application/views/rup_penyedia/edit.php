	...
	<div class="container">
			...
			<div class="card">
				<div class="card-body">
						...
						<div class="col-sm-4 mb-5">
							<?php if ($this->session->userdata('id_role') == 1) { ?>
								<select name="id_unit_kerja" id="id_unit_kerja" class="form-control select2">
									<option value="<?= $yu_kerja['id_unit_kerja'] ?>"><?= $angga['nama_unit_kerja'] ?></option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-4  mb-5">
							<select required name="id_metode_pemilihan" id="id_metode_pemilihan" class="form-control select2">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<button type="button" class="btn btn-primary m-2 w-100" onclick="edit_rup()">Simpan</button>
			</div>
		</div>
	</div>
					...
					<form action="#" id="formDataLokasiPekerjaan">
						...
						<div class="form-group">
							<select name="id_provinsi" id="provinsi2" class="form-control select2bs4">
								<option value="" class="form-control form-control-sm select2">--Provinsi---</option>
