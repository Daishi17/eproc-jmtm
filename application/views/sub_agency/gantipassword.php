  ...
  <div id="main" class="container">
  	...
  	<ol class="breadcrumb" style=" background-image: linear-gradient(to top,rgb(35, 32, 223),rgba(11, 76, 255, 0.63)) !important;">
  		<li><a style="text-decoration: none; color:white;" href="#">Ganti Password Sub Agency</a></li>
  	</ol>
  	...
  	<div class="content">
  		<div class="row">
  			...
  			<div class="col-md-9">
  				...
  				<form action="<?= base_url('subagency/gantipassword/' . $pegawai['id_pegawai']) ?>" method="POST">
