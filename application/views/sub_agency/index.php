...
<div class="container">
	...
	<ol class="breadcrumb" style="background-image: linear-gradient(to top, rgb(252, 252, 252), rgb(75, 136, 250)) !important;">
		<li><a style="text-decoration: none; color:black;" href="#">Data Sub Agency</a></li>

	</ol>

	<div class="content">
		<form action="#" method="POST" id="formData" class="float-right">
			<a href="<?= base_url('subagency/tambah_sub_agency') ?>" style="width:200px" class="btn btn-primary btn-sm mt-1 mb-3"> <i class="fas fa fa-user"></i> Tambah Sub Agency
			</a>
		</form>
		<br><br>
		<br>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" id="formData">
					<input type="hidden" name="id_sub_agency" id="id_sub_agency">
					<div class="form-group">
						...
						<p class="nama_agency-error text-danger"></p>
