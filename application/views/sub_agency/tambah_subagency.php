  ...
  <div class="container">
  	...
  	<ol class="breadcrumb" style="background-image: linear-gradient(to top, rgb(252, 252, 252), rgb(75, 136, 250)) !important;">
  		<li><a style="text-decoration: none; color:black;" href="#">Tambah Agency</a></li>
  	</ol>
  	<div class="content">
  			...
  			<form action="#" id="formData">
  				<table class="table">
  					<tr>
  						...
  						<td colspan="3"> <input type="text" name="nama_pegawai" class="form-control form-control-sm" placeholder="Nama Agency">
