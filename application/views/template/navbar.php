...
<li id="menu-item-444" class=" menu-item menu-item-type-post_type menu-item-object-page menu-item-444"><a style="font-weight: bold;" target="_blank" href="https://www.youtube.com/channel/UClIEkFcZ45Xvxo0bdxGgtdA"><i class="fab fa-youtube"></i> Official Youtube</a>
							</li>
					...
					<nav class="site-navigation no-show">
						<div class="menu-menu-primary-container">
							<ul id="menu-menu-primary" class="menu">
								<li id="menu-item-62" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-62"><a style="color:white;font-weight: bold;" href="#"><i class="fas fa fa-home"></i> Beranda</a></li>
								<li id="menu-item-355" style="margin-left: -10px;" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-355"><a style="color:white;font-weight: bold;" href="<?= base_url('home/cari_paket') ?>"><i class="fab fa-searchengin"></i> Cari Paket</a></li>
								...
								<li id="menu-item-12" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-12">
									...
									<ul class="sub-menu btn-grad3">
										...
										<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-356"><a style="color:black;" href="https://eproc.jmtm.co.id/auth">Non Penyedia</a></li>
										<!--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-355"><a style="color:black;" href="http://localhost/jmtm-vendor/auth">Penyedia</a></li>-->
						...
						<!-- <div class="site-search">
								<form method="get" id="searchform" action="http://telkominfra.co.id/">
		...
		<!-- <div class="container">
			<div class="container">
				<div class="site-header_features">
					<div class="row justify-content-end mr-0">
						<div class="features-wrapper text-white" style="height:56px">
							<div class="feature">
								<figure class="feature__image">
									<img src="http://telkominfra.co.id/wp-content/uploads/2019/01/icon-snow.png" alt="">
								</figure>
								<div class="feature__detail">
									<h2 class="text-white" style="margin-bottom: -30px !important;">
										SOLID </h2>

								</div>
							</div>
							<div class="feature">
								<figure class="feature__image"><img src="http://telkominfra.co.id/wp-content/uploads/2019/01/icon-run.png" alt="">
								</figure>
								<div class="feature__detail">
									<h2 class="text-white" style="margin-bottom: -30px !important;">
										Speed </h2>
							...
							<div class="feature">
								<figure class="feature_image"><img src="http://telkominfra.co.id/wp-content/uploads/2019/01/icon-light.png" alt="">
								</figure>
								<div class="feature__detail">
									<h2 class="text-white">
										Smart </h2>
	...
	<div class="container">
		<div class="container">
			<div class="hero-slider" style="margin-top: 3px;">
				<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" style="max-width: 100%;">
					<div class="carousel-inner">
						<div class="carousel-item">
							<img class="d-block w-100" style="height: 50%;" src="<?= base_url('assets/img/slider/banner.jpg') ?>" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" style="height: 50%;" src="<?= base_url('assets/img/slider/slide3.jpg') ?>" alt="Third slide">
						</div>
						<div class="carousel-item active">
							<img class="d-block w-100" style="height: 50%;" src="<?= base_url('assets/img/slider/slide1.jpg') ?>" alt="First slide">
						</div>
					</div>
		...
		<section class="section-feature-grid bg-white" style="height:220px">
			<div class="container">
				<div class="row">
					<div class="col">
						<a href="#" class="btn-grad5">
							<span class="detail">
								<h2 class="p-3"><strong><span style="color:white ;">Tender </span></strong>
								</h2><label style="font-size: 18px;" class="p-3 text-white">SELAMAT DATANG DI <br>E-PROCUREMENT JASAMARGA <br>TOLLROAD MAINTENANCE</label>
							</span>
							<img class="p-3 float-right" style="margin-top: -60px; width:200px" src="<?= base_url('assets/img/JasaMarga_new_tender.png') ?>">
						</a>
					</div>
					<div class="col">
						<img class="btn-grad5" style="width:100%" src="<?= base_url('assets/img/jmgif.gif') ?>">
		...
		<div class="marquee">
			<div>
				<?php foreach ($berita as $key => $value) { ?>
					<span>
						<img width="150px" alt="LPSE" src="<?= base_url() ?>assets/img/jmtm2.png" />
						<a href="#" class="tulisan_jalan"><?= $value['nama_berita'] ?> : <?= $value['created_at'] ?> </a>
					</span>
				<?php } ?>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="container marketing">
						<img src="<?= base_url('assets/img/jmtm2.png') ?>" alt="logo">
						<!-- Area kotak -->
						<div class="kotak">
							<!-- area profil -->
							<div class="profile">
